/**
   * Create By AzumiiDev
   * Follow https://github.com/shikizumii
*/
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/5d04c2c7b6df55d412105.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⌕ 15k Per Group via E-Walet 1 Month\n⌕ 20k via pulsa 1 Month\n\n Premium Price Bot\n⌕ 10k per User 1 bulan\n\nPayment can be via Paypal/link aja/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6285319362616 (Owner)\n\nDonate For Me : \n\n⌕ Paypal : https://www.paypal.me/\n⌕ Saweria : https://saweria.co/ktyyyzzm` }, { quoted: m })
            }
            break
	        ...
	        anu = `
⌕ Script : https://github.com/shikizumii/ShB-MD
⌕ Script ori : https://github.com/DikaArdnt/Hisoka-Morou

Jangan lupa kasih bintang.
⌕ Donate : 6285319362616 (Telkomsel)
⌕ Saweria : https://saweria.co/ktyyyzzm
⌕ Paypal : https://www.paypal.me/
...
`
	                let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://instagram.com/shikizumii_xyz'
                                }
                            }]
...
//────────────────────[ MAIN MENU HOOOOOOHHH ]────────────────────
             ...
             kon = await getBuffer(`https://telegra.ph/file/5d04c2c7b6df55d412105.jpg`)
...
`
            ...
            case 'menuall': case 'allmenu': {
                buffer = await getBuffer(`https://telegra.ph/file/5d04c2c7b6df55d412105.jpg`)
